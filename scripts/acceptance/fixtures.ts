...
export const ACCEPTANCE_FIXTURES: AcceptanceFixture[] = [
  {
    ...
    input: {
      input: "Joris completed 142 customer conversations this quarter, helped resolve 96% of escalations, launched 4 product improvements, and received a 4.8 out of 5 customer rating. The strongest month was June with 54 conversations.",
      instructions: "Create a celebratory quarterly recap. Keep every metric exact and make the achievement feel personal.",
      opening: "Joris, your quarter deserves a look back.",
      personalization: { firstName: "Joris", period: "Q2", role: "Product leader" },
  ...
  },
  {
    ...
    input: {
      ...
      opening: "Hi Joris — here is your daily product briefing.",
      personalization: { firstName: "Joris", role: "Product leader", focus: "activation" },
  ...
  },
  {
    ...
    input: {
      input: "Joris joined Acme Cloud as VP Product. His onboarding goals are to meet the leadership team, review the activation dashboard, and publish a 30-day product assessment. His onboarding partner is Maya.",
      instructions: "Welcome Joris personally and turn the three grounded onboarding goals into a clear first-week path.",
      opening: "Welcome to Acme Cloud, Joris.",
      personalization: { firstName: "Joris", role: "VP Product", onboardingPartner: "Maya" },
